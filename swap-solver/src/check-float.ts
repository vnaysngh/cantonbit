...
const DEVNET = {
  ...
  party: "warpx-devnet-1::1220231c1885f289f90e0d08b448579c31a655b5826802c6d885258a27371039fba9",
};
...
async function main() {
  ...
  console.log(`network: ${isMainnet ? "MAINNET" : "devnet/other"}  ledger=${new URL(ledgerHost).host}\n`);
  ...
  const clientSecret = !isMainnet && process.env.KEYCLOAK_CLIENT_SECRET_DEVNET
  ...
  const client = new CantonClient(
    { ledgerHost, registryUrl, decentralizedPartyId: admin, instrumentId: { admin, id: "CBTC" }, solverParty: party },
