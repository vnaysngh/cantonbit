-- Reserve solver WBTC before the user's Canton leg is locked. Reservations remain
-- active through main_locking/main_locked/counter_locking and are released only
-- after the EVM counter-lock is proven or the order is refunded/cancelled.
