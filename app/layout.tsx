...
import { SwapFeatureFlagsProvider } from "@/hooks/useSwapFeatureFlags";
...
import { readSwapFeatureFlagsSnapshot } from "@/lib/swap-feature-flags";

// Nonce-based CSP requires request-time rendering so every script tag receives
// the nonce generated by proxy.ts for that specific response.
...
export default function RootLayout({
  ...
  const swapFeatureFlags = readSwapFeatureFlagsSnapshot();
              ...
              <LoopWalletProvider>
                <WalletProvider>
                  <CantonIdentityProvider>
                    <SwapFeatureFlagsProvider flags={swapFeatureFlags}>
                      <AppShell>{children}</AppShell>
                    </SwapFeatureFlagsProvider>
                  </CantonIdentityProvider>
                </WalletProvider>
              </LoopWalletProvider>
            </EvmWalletProvider>
